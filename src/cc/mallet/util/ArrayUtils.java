...
final public class ArrayUtils {
    ...
    /**
     * Returns true if the procedure proc returns true for any element of the
     * array v.
     */
    ...
    /**
     * Returns a new array containing all of a, with additional extra space
     * added (zero initialized).
     *
     * @param a
     * @param additional
     * @return
