...
import cc.mallet.topics.MirrorParallelTopicModel.SkewType;
import java.io.*;
import java.util.*;
import java.text.*;
...
public class MirrorTopicModelDiagnostics {
    ...
    MirrorParallelTopicModel model;
    Alphabet alphabet;
    ...
    public MirrorTopicModelDiagnostics(MirrorParallelTopicModel model, int numTopWords) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        MirrorParallelTopicModel model = new MirrorParallelTopicModel(numTopics, 5.0, 0.1, 0.1, false, SkewType.LabelsOnly);
        model.addInstances(instances);
        model.setNumIterations(1000);

        model.estimate();

        MirrorTopicModelDiagnostics diagnostics = new MirrorTopicModelDiagnostics(model, 20);
