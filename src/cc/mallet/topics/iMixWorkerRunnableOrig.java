 ...
 *
 */
public class iMixWorkerRunnableOrig implements Runnable {
    ...
    public iMixWorkerRunnableOrig(int numTopics, int numIndependentTopics,
            ...
            double[][] typeSkewIndexes, iMixParallelTopicModelOrig.SkewType skewOn, double[] skewWeight, double[][] p_a, double[][] p_b) {
