...
public class MixTopicModelDiagnosticsNP {
    ...
    public MixTopicModelDiagnosticsNP(MixParallelTopicModelNP model, int numTopWords) {
        numTopics = model.getActiveNumTopics();
    ...
    public static void main(String[] args) throws Exception {
        ...
        MixParallelTopicModelNP model = new MixParallelTopicModelNP(numTopics,1000, (byte) 1);
        model.addInstances(training);
        model.setNumIterations(1000);

        model.estimate();

        MixTopicModelDiagnosticsNP diagnostics = new MixTopicModelDiagnosticsNP(model, 20);
