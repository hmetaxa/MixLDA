 ...
 *
 */
public class MixWorkerRunnableTest implements Runnable {
    ...
    public MixWorkerRunnableTest(int numTopics,
    ...
    public void buildLocalTypeTopicCounts() {
        ...
        for (int doc = startDoc;
            ...
            for (Byte i = 0; i < numModalities; i++) {
                ...
                if (document.instance.getData() != null) {
                ...
                if (tokenSequence[m] != null) {
                    ...
                    while (index < currentTypeTopicCounts.length
                        ...
                        if (!alreadyDecremented
                            ...
                            score =
                                    (cachedCoefficients[m][currentTopic] + smoothOnlyCachedCoefficients[m][currentTopic] /// docLength[m])
                                    ) * currentValue;
                            topicTermMass += score;
