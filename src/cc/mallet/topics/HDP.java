 ...
 * ==================================================================================================
 * TODO List:
 * - export Inference result
 * - implement functions used from knowceans
 * 
 * Update History:
 * 
 * 2012/10/02 version 0.1
...
public class HDP {
	...
	private int addTopic(int m, int type) {
	 ...
	 private void printTopWordTest(int numWords){
	 ...
	 public void exportWordDistribution(String outFileName) throws Exception{
		 //TODO
		 FileWriter fstream = new FileWriter(outFileName);
		 BufferedWriter out = new BufferedWriter(fstream);
	 ...
	 public void exportTopicDistribution(String outFileName)throws Exception{
		 ...
		 double[] topicsProb;
		  ...
		  for(int i=0; i < instances.size(); i++){
			  ...
			  topicsProb = this.topicDistribution(i);
			  out.write((String)instances.get(i).getName() + "," + (String)instances.get(i).getTarget()+ ",");
	 ...
	 public double[][] getTopicSimilarity(){
		 ...
		 double[][] similarity = new double[K][K];
		 ...
		 for(int i =0 ; i < K ; i++){
			 for(int j=i+1 ; j<K ; j++){
				 ...
				 double denum1 = nk.get(i)+betaSum;
				 double denum2 = nk.get(j)+betaSum;
				 double num1, num2;
				 double sim;
				 
				 for(int k=0 ; k < numTypes ; k++){
					 
					 num1 = nkt.get(i)[k]+beta;
					 num2 = nkt.get(j)[k]+beta;
