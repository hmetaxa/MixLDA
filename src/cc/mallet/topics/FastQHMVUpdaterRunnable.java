 ...
 * @author Omiros
 */
public class FastQHMVUpdaterRunnable implements Runnable {

    public static Logger logger = MalletLogger.getLogger(FastQHMVUpdaterRunnable.class.getName());
    ...
    public FastQHMVUpdaterRunnable(
            int[][][] typeTopicCounts,
            int[][] tokensPerTopic,
            FTree[][] trees,
